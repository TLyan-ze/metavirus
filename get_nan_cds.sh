...
Host_info=/ldfssz1/ST_INFECTION/P20Z10200N0206_pathogendb/yanzeqin/metavirus/scripts/VMR_180521_MSL36.xlsx
rdrp_family=/ldfssz1/ST_INFECTION/P20Z10200N0206_pathogendb/yanzeqin/metavirus/Lastest/Viruses.fullnamelineage.dmp
#比对结果所在的路径
#样本名对应的文件夹名
basedir=$1
samplesbatchsdate=$2
out_info=$basedir/$samplesbatchsdate/${samplesbatchsdate}_nan_contig
#获取CAT注释为RNA病毒的contigs的id和信息
catsmp_file=$basedir/$samplesbatchsdate/04.assemble_megahit_nr/0401.CAT_note_RNA/${samplesbatchsdate}.virus.contig.info
Cat_RNAVirusContigs_info=$basedir/$samplesbatchsdate/03.QC_asssemble_stats/${samplesbatchsdate}.nan_info
Cat_RNAVirusContigs_id=$basedir/$samplesbatchsdate/03.QC_asssemble_stats/${samplesbatchsdate}.nan_id
grep -v Riboviria $catsmp_file|grep -v Duplodnaviria|awk '$4 !~/dsDNA-RT/ {print $1}' |sort|uniq > $Cat_RNAVirusContigs_id
grep -v Riboviria $catsmp_file|grep -v Duplodnaviria|awk '$4 !~/dsDNA-RT/ {print $0}' |sort|uniq > $Cat_RNAVirusContigs_info
#CheckV结果

CheckV_out=$basedir/$samplesbatchsdate/04.assemble_megahit_nr/0407.CatRNAVirus_check
#contig长度
contigs_length=$basedir/$samplesbatchsdate/03.QC_asssemble_stats/megahit_seqkit_fx2tab.txt
#得到最佳的比对rdrp的几个
blastp2RdRp_out=$basedir/$samplesbatchsdate/04.assemble_megahit_nr/0402.CATpreProtein_blastp_rdrp/${samplesbatchsdate}.CAT_prodigal_proteins_blastp2RdRp
blastp2RdRp_id=$basedir/$samplesbatchsdate/04.assemble_megahit_nr/0402.CATpreProtein_blastp_rdrp/${samplesbatchsdate}.CAT_prodigal_proteins_blastp2RdRp.id
awk '{print $1}' $blastp2RdRp_out|sort|uniq > $blastp2RdRp_id
blastp2RdRp_out_besthit=$basedir/$samplesbatchsdate/04.assemble_megahit_nr/0402.CATpreProtein_blastp_rdrp/${samplesbatchsdate}.CAT_prodigal_proteins.blastp2RdRp.besthit.blastp
blastp2RdRp_out_match=$basedir/$samplesbatchsdate/04.assemble_megahit_nr/0402.CATpreProtein_blastp_rdrp/${samplesbatchsdate}.CAT_prodigal_proteins.blastp2RdRp.match.blastp
...
#比对nt库的结果
blastn_info=$basedir/$samplesbatchsdate/04.assemble_megahit_nr/0402.CATpreProtein_blastp_rdrp/${samplesbatchsdate}.CatRNAVirus_nt.blastn
blastn_id=$basedir/$samplesbatchsdate/04.assemble_megahit_nr/0402.CATpreProtein_blastp_rdrp/${samplesbatchsdate}.CatRNAVirus_nt.blastn.id
awk '{print $1}' $blastn_info|sort|uniq > $blastn_id
blastn_out=$basedir/$samplesbatchsdate/04.assemble_megahit_nr/0402.CATpreProtein_blastp_rdrp/${samplesbatchsdate}.CatRNAVirus_nt_best.blastn
...
#覆盖度结果
sofa_out=$basedir/$samplesbatchsdate/03.QC_asssemble_stats/${samplesbatchsdate}_virus_sofa.txt
Cat_sofa_info=$basedir/$samplesbatchsdate/03.QC_asssemble_stats/${samplesbatchsdate}_virus_coverage.txt
awk '$1 ~ /k/ {print $1,$3,$4}' $sofa_out|awk -F : '{print $1,$3,$4}'|awk '{print $1"\t"$2"\t"$4}'> $Cat_sofa_info
#共线性的结果
gong_info=$basedir/$samplesbatchsdate/05.prescreening/0503.tblastx_virus/${samplesbatchsdate}.contigspecies_info
gong_coverage=$basedir/$samplesbatchsdate/05.prescreening/0503.tblastx_virus/${samplesbatchsdate}.gong_coverage_txt
#psi-blast的结果
psi_blast=$basedir/$samplesbatchsdate/04.assemble_megahit_nr/0401.CAT_note_RNA/${samplesbatchsdate}.predicted_proteins.faa.cdds.psiblast
rps_blast=$basedir/$samplesbatchsdate/04.assemble_megahit_nr/0401.CAT_note_RNA/${samplesbatchsdate}.predicted_proteins.faa.cdds.rpsblast
psi_rps_blast=$basedir/$samplesbatchsdate/04.assemble_megahit_nr/0401.CAT_note_RNA/${samplesbatchsdate}.predicted_proteins.faa.cdds.he
cat $psi_blas > $psi_rps_blast
cat $rps_blast >> $psi_rps_blast
psi_blast_id=$basedir/$samplesbatchsdate/04.assemble_megahit_nr/0401.CAT_note_RNA/${samplesbatchsdate}.predicted_proteins.faa.cdds.psiblast.id
awk '{print $1}' $psi_rps_blast|sort|uniq > $psi_blast_id
psiblast_out_besthit=$basedir/$samplesbatchsdate/04.assemble_megahit_nr/0401.CAT_note_RNA/${samplesbatchsdate}.predicted_proteins.faa.cdds.best.psiblast
